...
public class ClienteOCSKairos {
   ...
   public static void main(String[] args) {
		...
		cobro.setMediatorId(new BerInteger(23));
		cobro.setServiceProviderId(new MerchantId(new String("222").getBytes("UTF-8")));
		cobro.setContentId(new AgregatedId(new String("111").getBytes("UTF-8")));
		cobro.setContentType(new BerInteger(10));
		cobro.setUnitsRequested(new BerInteger(10000));
		cobro.setEventUniqueIdentifier(new TxnId(new String("123-123-321-321").getBytes("UTF-8")));
		cobro.setChargingTime(new DateTimeStamp(new String("2021-11-19T09:00:00.000").getBytes("UTF-8")));
		cobro.setProfileType(new ProfileType(new String("abcde").getBytes("UTF-8")));
		cobro.setAdditionalInfo(new BerPrintableString(new String("<userIdentity>1.1.1.1:9000</UserIdentity>").getBytes("UTF-8")));
